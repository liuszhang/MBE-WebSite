...
<!-- Mirrored from www.model-based-enterprise.org/capability-level-3.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jun 2016 08:58:11 GMT -->
<head>
	<!-- begin meta -->
	<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=8, IE=9, IE=10">
<title>Model Based Enterprise Capability Level 3</title>
	<meta name="description" content="The Model Based Enterprise level 2 is the first capability level to consider the 3D model are combined with the drawing as the master source of the product definition."/>
<meta name="keywords" content="Model Based Enterprise, level, 3, capability, level, 3D models, master source, product definition, process."/>
	...
	<!-- begin content -->
        <section id="content" class="container clearfix">
            ...
            <header id="page-header">
            	<h1 id="page-title">Model Based Enterprise Capability Level 3</h1>	
            </header>
            <!-- end page header -->
            	...
            	<div class="widget">
            	  <nav>
					  <ul class="menu">
                         ...
                         <li class="current-menu-item"><a href="capability-level-3.aspx">Level 3</a></li>
            ...
            <section class="three-fourths column-last">
              <div id="content2">
                <h1>How to Get Started – Level 3</h1>
                    ...
                    <p> The chart below defines the Model Based Enterprise Capability Level 3: <br>
                    (Note: Changes from Level 2 are highlighted in yellow) </p>
              <div class="entry-image float-left">
                      <div class="entry-image">
                        <a class="fancybox" href="images/Level-3.jpg" title="Capability Level 3"><span class="overlay zoom"></span><img src="images/Level-3.jpg" alt="Level 3"></a>
              </div></div>
...
<!-- Mirrored from www.model-based-enterprise.org/capability-level-3.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jun 2016 08:58:31 GMT -->
</aspx>
