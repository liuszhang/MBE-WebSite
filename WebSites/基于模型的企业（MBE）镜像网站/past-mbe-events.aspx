...
<!-- Mirrored from www.model-based-enterprise.org/past-mbe-events.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jun 2016 09:01:38 GMT -->
<head>
	<!-- begin meta -->
	<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=8, IE=9, IE=10">
<title>Past Model Based Enterprise Events | Overviews and archived information about past events.</title>
	<meta name="description" content="Look up the information on past model based enterprise events and review highlights and information regarding past but important events"/>
<meta name="keywords" content="Past, Model based enterprise, events, archived events, MBE Efforts within the DoD, MBE Technical Data Package Development, Supplier Education, Training Summit"/>
        ...
        <!-- end header top -->
            ...
            <nav id="nav">
                ...
                <li><a href="index-2.aspx" data-rel="submenu1">Home</a>
                    ...
                    <li class="current"><a href="mbe-events.aspx" data-rel="submenu5">MBE Events</a>
                    </li>
	...
	<!-- begin content -->
        <section id="content" class="container clearfix">
            ...
            <header id="page-header">
            	<h1 id="page-title">Past Events | Model Based Enterprise </h1>	
            </header>
            <!-- end page header -->
            	...
            	<div class="widget">
            	  <nav>
					  <ul class="menu">
							...
							<li class="current-menu-item"><a href="past-mbe-events.aspx">Past Events</a></li>
					</ul>
					</nav>
				</div>
            </aside>
