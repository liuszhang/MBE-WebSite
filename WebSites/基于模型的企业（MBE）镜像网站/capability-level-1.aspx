...
<!-- Mirrored from www.model-based-enterprise.org/capability-level-1.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jun 2016 08:58:48 GMT -->
<head>
	<!-- begin meta -->
	<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=8, IE=9, IE=10">
<title>Model Based Enterprise Capability Level 1</title>
	<meta name="description" content="The Model Based Enterprise level 1 designation describes a company’s capability level is the first level to begin to effectively use the 3D Model"/>
<meta name="keywords" content="Model Based Enterprise, level, 1, capability, level, 3D models, manufacturing process."/>
	...
	<!-- begin content -->
        <section id="content" class="container clearfix">
            ...
            <header id="page-header">
            	<h1 id="page-title">Model Based Enterprise Capability Level 1</h1>	
            </header>
            <!-- end page header -->
            	...
            	<div class="widget">
            	  <nav>
					  <ul class="menu">
                         ...
                         <li class="current-menu-item"><a href="capability-level-1.aspx">Level 1</a></li>
            ...
            <section class="three-fourths column-last">
              <div id="content2">
                <h1>How to Get Started – Level 1</h1>
                    ...
                    <p> The chart below defines the Model Based Enterprise Capability Level 1: <br>
                    (Note: Changes from Level 0 are highlighted in yellow) </p>
              <div class="entry-image float-left">
                      <div class="entry-image">
                    <a class="fancybox" href="images/Level-1.jpg" title="Capability Level 1"><span class="overlay zoom"></span><img src="images/Level-1.jpg" alt="Level 1"></a></div></div>
...
<!-- Mirrored from www.model-based-enterprise.org/capability-level-1.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jun 2016 08:59:05 GMT -->
</aspx>
