...
<!-- Mirrored from www.model-based-enterprise.org/capability-level-2.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jun 2016 08:58:31 GMT -->
<head>
	<!-- begin meta -->
	<meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=8, IE=9, IE=10">
<title>Model Based Enterprise Capability Level 2</title>
	<meta name="description" content="The Model Based Enterprise level 2 is essentially the same as Level 1 except instead of using neutral files it centers on the reuse of the native CAD data"/>
<meta name="keywords" content="Model Based Enterprise, level, 2, capability, level, 3D models, manufacturing process."/>
	...
	<!-- begin content -->
        <section id="content" class="container clearfix">
            ...
            <header id="page-header">
            	<h1 id="page-title">Model Based Enterprise Capability Level 2</h1>	
            </header>
            <!-- end page header -->
            	...
            	<div class="widget">
            	  <nav>
					  <ul class="menu">
                         ...
                         <li class="current-menu-item"><a href="capability-level-2.aspx">Level 2</a></li>
            ...
            <section class="three-fourths column-last">
              <div id="content2">
                <h1>How to Get Started – Level 2</h1>
                    ...
                    <p> The chart below defines the Model Based Enterprise Capability Level 2: <br>
                    (Note: Changes from Level 1 are highlighted in yellow) </p>
              <div class="entry-image float-left">
                      <div class="entry-image">
                    <a class="fancybox" href="images/Level-2.jpg" title="Capability Level 2"><span class="overlay zoom"></span><img src="images/Level-2.jpg" alt="Level 2"></a></div></div>
...
<!-- Mirrored from www.model-based-enterprise.org/capability-level-2.aspx by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 20 Jun 2016 08:58:48 GMT -->
</aspx>
